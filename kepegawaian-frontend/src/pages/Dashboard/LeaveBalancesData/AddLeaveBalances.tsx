...
export default function AddLeaveBalancesForm() {
  ...
  const addLeaveBalances = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const res = await axios.post(
        "http://localhost:3000/api/v1/createLeaveBalances",
        {
          year: year,
      ...
      <main className="min-h-screen md:pl-[248px]">
        ...
        <div className="mx-auto max-w-[1520px] px-5 py-7 sm:px-8 lg:px-10 lg:py-9">
          ...
          <div className="mx-auto mt-10 max-w">
            <Card>
              <CardContent>
                <form className="space-x-4 p-6" onSubmit={addLeaveBalances}>
                  <div className="mb-5">
                    <label
                      htmlFor="year"
